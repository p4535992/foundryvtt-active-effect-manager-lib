...
import { filterStatusButtons, findAllStatusEffectButtons, findEffectsButton, findStatusEffectButtonsContainingSearchTerm, isPF2E } from "./effects/effect-quick-status";
...
export const readyHooks = (): void => {
    ...
    if (game.settings.get(CONSTANTS.MODULE_NAME, "enableQuickStatusEffect")) {
        Hooks.once('canvasReady', async () => {
            ...
            let inputString = '';
            if (isPF2E()) {
                inputString = '<input class="active-effect-manager-lib-quick-input-pf2e" id="active-effect-manager-lib-quick-input" type="text" placeholder="filter conditions..." ></input>';
            } else {
                inputString = '<input class="active-effect-manager-lib-quick-input" id="active-effect-manager-lib-quick-input" type="text" placeholder="filter conditions..." ></input>';
            }
